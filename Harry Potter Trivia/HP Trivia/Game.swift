...
//  HP Trivia
//
//  Created by Алеся Афанасенкова on 31.01.2025.
//
...
class Game: ObservableObject {
    ...
    func newQuestion() {
        ...
        var potentialQuestions = filteredQuestions.randomElement()!
        while answeredQuestions.contains(potentialQuestions.id) {
            potentialQuestions = filteredQuestions.randomElement()!
        }
        currentQuestion = potentialQuestions
